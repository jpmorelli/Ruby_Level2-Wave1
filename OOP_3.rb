...
temp_convert = Temperatura.new(type,value)
byebug ## Con BYEBUG puedo frenar el programa y tirar comandos para saber en que estado estan las variables y procesos.
